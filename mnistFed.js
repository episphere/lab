...
import { WebFed } from "./webFed_yjs.js"
...
mnist.ui.joinFederationHandler = async (selfName) => {
  ...
  mnist.ui.writeToConsole(`Joined federation ${mnist.webFed.federationName} as a client with ID: ${selfName}...`)
